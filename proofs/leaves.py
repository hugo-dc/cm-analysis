...
stats = ['', 'Total leaves:' + str(len(leaves))]
html_leaves = html.html_lines(leaves + stats)
html.write_html('leaves.html', html_leaves)

stats = ['', 'Total hashes:' + str(len(hashes))]
html_hashes = html.html_lines(hashes + stats)
html.write_html('hashes.html', html_hashes)
